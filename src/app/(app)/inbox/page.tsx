  ...
  return (
    <PageShell>
      {error ? (
        <Card>
          <CardHeader>
            <CardTitle className="text-sm font-semibold">Inbox unavailable</CardTitle>
      ...
      <div className="grid gap-4 lg:grid-cols-[320px_1fr]">
        ...
        <Card className="lg:h-[calc(100vh-11rem)]">
          ...
          <CardContent className="space-y-1 overflow-y-auto p-2 lg:max-h-[calc(100vh-17rem)]">
            {chats === null ? (
        ...
        <Card className="flex flex-col lg:h-[calc(100vh-11rem)]">
          <CardHeader className="pb-3">
            {active ? (
              ...
              <>
                <CardTitle className="text-sm font-semibold">New message</CardTitle>
                <CardDescription className="text-xs">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between gap-2">
                ...
                <Button
                  ...
                  size="sm"
                  onClick={send}
                  disabled={sending || (!activeId && !newNumber.trim()) || (!draft.trim() && !product)}

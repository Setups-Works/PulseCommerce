    ...
    <div className="space-y-4">
      <div className="grid gap-4 lg:grid-cols-3">
        <Card className="lg:col-span-1">
          <CardHeader>
            <CardTitle className="text-sm font-semibold">Build a flow</CardTitle>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="flex gap-1.5">
                <Button
                  type="button"
                  size="sm"
                  variant={exitOn === "ordered" ? "default" : "outline"}
                ...
                <Button
                  type="button"
                  size="sm"
                  variant={exitOn === "none" ? "default" : "outline"}
            ...
            <Button className="w-full gap-1.5" disabled={!valid || busy !== null} onClick={create}>
              {busy === "create" ? (

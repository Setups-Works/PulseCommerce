  ...
  return (
    <>
        ...
        <div className="flex min-w-0 items-center gap-3">
          ...
          <div className="min-w-0 space-y-1">
            ...
            <div className="flex flex-wrap items-center gap-1.5">
              ...
              <Chip variant={customer.isNewCustomer ? "secondary" : "soft"} className="text-[10px]">
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <Card>
          <Card.Header>
            <Card.Title className="text-sm font-semibold">RFM scores</Card.Title>
      ...
      <Card>
        <Card.Header>
          <Card.Title className="text-sm font-semibold">Order history</Card.Title>
          <Card.Description className="text-xs">
            {loadingHistory
              ? "Loading orders…"

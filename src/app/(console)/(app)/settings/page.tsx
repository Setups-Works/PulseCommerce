  ...
  return (
    <PageShell>
        ...
        <Card.Header>
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="space-y-1">
              <Card.Title className="text-sm font-semibold">WooCommerce connection</Card.Title>
              <Card.Description className="text-xs">
                Authorized through WooCommerce with read-only scope. Nothing is ever written back to your store.
              </Card.Description>
            </div>
            <Chip variant={connected ? "secondary" : "soft"} className="gap-1.5">
              {connected ? (
                <>
      ...
      {stores.length > 1 ? (
        <Card>
          <Card.Header>
            <Card.Title className="text-sm font-semibold">Connected stores</Card.Title>
            <Card.Description className="text-xs">
            ...
            {stores.map((store) => (
              ...
              >
                ...
                <div className="flex items-center gap-2">
                  {store.active ? (
                    <Chip color="default" className="gap-1 text-[10px]">
      ...
      <Card>
        ...
        <Card.Content>
          <form action="/api/auth/woo/start" method="get" className="flex flex-wrap items-end gap-3">
            ...
            <Button type="submit" className="gap-1.5" isDisabled={storeUrl.trim().length < 4}>
      ...
      {connected ? (
        <Card>
          <Card.Header>
            <Card.Title className="text-sm font-semibold">Data window</Card.Title>
            <Card.Description className="text-xs">
          ...
          <Card.Footer className="border-t pt-4">
            <Button size="sm" onClick={saveWindow} isDisabled={savingWindow}>
      ...
      {/* --- Colophon ------------------------------------------------------ */}
      <Card>
        <Card.Content className="flex flex-wrap items-center justify-between gap-4 py-5">
          <div className="space-y-1">

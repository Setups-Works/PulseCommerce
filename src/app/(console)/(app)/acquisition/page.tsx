    ...
    <>
      ...
      {!acquisition.hasAttribution ? (
        ...
        <>
          ...
          <Card>
            <Card.Header>
              <Card.Title className="text-sm font-semibold">Channel performance</Card.Title>
      ...
      <Card.Header className="gap-3">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div className="space-y-1">
            ...
            <Card.Description className="max-w-prose text-xs">
              {COPY[tab]}
...
function buildColumns(fmt: Formatters): ColumnDef<ChannelRecord, unknown>[] {
  return [
    ...
    },
    {
      ...
      header: "Top device",
      cell: ({ row }) => (
        <Chip variant="soft" className="gap-1 text-[10px]">

        ...
        <div className="mx-auto w-full max-w-3xl">
          <div className="flex items-end gap-2 rounded-2xl border bg-card p-2 shadow-sm focus-within:ring-1 focus-within:ring-ring">
            ...
            <Button
              ...
              aria-label="Send"
              isDisabled={thinking || draft.trim().length === 0}
      ...
      <AttachmentContent>
        ...
        {outcome ? (
          ...
          <div className="mt-2 flex gap-1.5">
            <Button size="sm" className="h-7 gap-1 px-2.5 text-[11px]" isDisabled={busy} onClick={onApprove}>
              {busy ? <Loader2 className="size-3 animate-spin" /> : <Check className="size-3" />}
              Approve
            </Button>
            <Button size="sm" variant="outline" className="h-7 gap-1 px-2.5 text-[11px]" isDisabled={busy} onClick={onReject}>
              <X className="size-3" />
              Reject
            </Button>
          </div>

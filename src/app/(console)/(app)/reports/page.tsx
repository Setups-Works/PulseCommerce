...
function ReportsContent({ data }: { data: AnalyticsResult }) {
  ...
  return (
    <>
        ...
        <Card.Header className="gap-3">
          <div className="flex flex-wrap items-start justify-between gap-3">
            <div className="space-y-1">
              <Card.Title className="text-sm font-semibold">Written report</Card.Title>
      ...
      <Card>
        <Card.Header>
          <Card.Title className="text-sm font-semibold">Report builder</Card.Title>
          <Card.Description className="text-xs">
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      "hover:border-primary/40 hover:bg-surface-secondary/50",
          ...
          return (
            <Card key={format.id} className="flex flex-col justify-between">
              <Card.Header className="gap-2">
                ...
                <Card.Description className="text-xs leading-relaxed">{format.detail}</Card.Description>
              </Card.Header>
              <Card.Content>
                <Button
                  className="w-full"
      ...
      <Card>
        <Card.Header>
          <Card.Title className="text-sm font-semibold">What&apos;s in each report</Card.Title>
        </Card.Header>
        <Card.Content>

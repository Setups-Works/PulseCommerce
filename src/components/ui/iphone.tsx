...
export interface IphoneProps extends HTMLAttributes<HTMLDivElement> {
  ...
  videoSrc?: string
  /**
   * Live DOM to render into the phone's screen, as an alternative to `src` or
   * `videoSrc`. Added to the registry component for the same reason as the one
   * on Safari: this product draws its screenshots from its own components
   * rather than capturing them, so the screen has to be real elements.
   */
